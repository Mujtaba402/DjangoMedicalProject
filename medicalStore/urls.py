...
router.register("join_medical_detail", views.JoinMedicalDetailsViewSet, basename="join_medical_detail")
router.register("reverse_medical_detail", views.ReverseMedicalDetailsViewSet, basename="reverse_medical_detail")
