...
class Medicine(models.Model):
    id=models.AutoField(primary_key=True)
    company_id = models.ForeignKey(Company, related_name="medicines", on_delete=models.CASCADE)
    name=models.CharField(max_length=255)
...
class MedicalDetails(models.Model):
    id=models.AutoField(primary_key=True)
    medicine_id=models.ForeignKey(Medicine, related_name="medical_detailss", on_delete=models.CASCADE)
